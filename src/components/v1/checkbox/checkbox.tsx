...
const base = [
  ...
  // Border
  "border border-mineshaft-950/15 group-data-checked:border-transparent group-data-hover:group-data-checked:border-transparent group-data-hover:border-mineshaft-950/30 group-data-checked:bg-(--checkbox-checked-border)",
  ...
  "group-data-disabled:border-mineshaft-950/25 group-data-disabled:bg-mineshaft-950/5 group-data-disabled:[--checkbox-check:var(--color-mineshaft-950)]/50 group-data-disabled:before:bg-transparent",
...
const colors = {
  "dark/mineshaft": [
    "[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-mineshaft-900)] [--checkbox-checked-border:var(--color-mineshaft-950)]/90",
    "dark:[--checkbox-checked-bg:var(--color-mineshaft-600)]",
  ],
  "dark/white": [
    "[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-mineshaft-900)] [--checkbox-checked-border:var(--color-mineshaft-950)]/90",
    "dark:[--checkbox-check:var(--color-mineshaft-900)] dark:[--checkbox-checked-bg:var(--color-white)] dark:[--checkbox-checked-border:var(--color-mineshaft-950)]/15",
  ],
  white:
    "[--checkbox-check:var(--color-mineshaft-900)] [--checkbox-checked-bg:var(--color-white)] [--checkbox-checked-border:var(--color-mineshaft-950)]/15",
  dark: "[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-mineshaft-900)] [--checkbox-checked-border:var(--color-mineshaft-950)]/90",
  mineshaft:
    "[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-mineshaft-600)] [--checkbox-checked-border:var(--color-mineshaft-700)]/90",
  ...
  primary:
    "[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-primary-500)] [--checkbox-checked-border:var(--color-primary-600)]/90",
