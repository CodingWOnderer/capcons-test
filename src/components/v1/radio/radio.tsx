...
const base = [
  ...
  // Border
  'border border-mineshaft-950/15 group-data-checked:border-transparent group-data-hover:group-data-checked:border-transparent group-data-hover:border-mineshaft-950/30 group-data-checked:bg-(--radio-checked-border)',
  ...
  '[--radio-indicator:transparent] group-data-checked:[--radio-indicator:var(--radio-checked-indicator)] group-data-hover:group-data-checked:[--radio-indicator:var(--radio-checked-indicator)] group-data-hover:[--radio-indicator:var(--color-mineshaft-900)]/10',
  // Indicator color (dark mode)
  'dark:group-data-hover:group-data-checked:[--radio-indicator:var(--radio-checked-indicator)] dark:group-data-hover:[--radio-indicator:var(--color-mineshaft-700)]',
  // Focus ring
  'group-data-focus:outline group-data-focus:outline-2 group-data-focus:outline-offset-2 group-data-focus:outline-blue-500',
  // Disabled state
  'group-data-disabled:opacity-50',
  'group-data-disabled:border-mineshaft-950/25 group-data-disabled:bg-mineshaft-950/5 group-data-disabled:[--radio-checked-indicator:var(--color-mineshaft-950)]/50 group-data-disabled:before:bg-transparent',
...
const colors = {
  'dark/mineshaft': [
    '[--radio-checked-bg:var(--color-mineshaft-900)] [--radio-checked-border:var(--color-mineshaft-950)]/90 [--radio-checked-indicator:var(--color-white)]',
    'dark:[--radio-checked-bg:var(--color-mineshaft-600)]',
  ],
  'dark/white': [
    '[--radio-checked-bg:var(--color-mineshaft-900)] [--radio-checked-border:var(--color-mineshaft-950)]/90 [--radio-checked-indicator:var(--color-white)]',
    'dark:[--radio-checked-bg:var(--color-white)] dark:[--radio-checked-border:var(--color-mineshaft-950)]/15 dark:[--radio-checked-indicator:var(--color-mineshaft-900)]',
  ],
  white:
    '[--radio-checked-bg:var(--color-white)] [--radio-checked-border:var(--color-mineshaft-950)]/15 [--radio-checked-indicator:var(--color-mineshaft-900)]',
  dark: '[--radio-checked-bg:var(--color-mineshaft-900)] [--radio-checked-border:var(--color-mineshaft-950)]/90 [--radio-checked-indicator:var(--color-white)]',
  mineshaft: '[--radio-checked-indicator:var(--color-white)] [--radio-checked-bg:var(--color-mineshaft-600)] [--radio-checked-border:var(--color-mineshaft-700)]/90',
